...
class Display:
    ...
    def draw_world_layer(self, the_canvas, layer, bias, condition):
        ...
        rgb_matrix = layer.reshape((3, self.the_dataset.num_rows, self.the_dataset.num_columns))
        for k in range(3):
